...
export default {
    ...
    methods: {
        ...
        getTeachPlan() {
            this.axios.get('http://127.0.0.1:8000/app1/showTeachPlans').then((response) => {
        ...
        onSubmit(data) {
            this.axios
            .post("http://127.0.0.1:8000/app1/addTeachPlans", { data, })
            .then(response => {
        ...
        onUpdate(data) {
            this.axios
            .post("http://127.0.0.1:8000/app1/updateTeachPlan", { data, })
            .then(response => {
              // this.listData = response.data.data;
              // console.log(this.listData)
              if (response.data.err_num == 1) {
        ...
        ondelete(tpno) {
            let data={tpno}
            this.axios
            .post("http://127.0.0.1:8000/app1/delTeachPlan", { data, })
            .then(response => {
              // this.listData = response.data.data;
              // console.log(this.listData)
              if (response.data.err_num == 1) {
